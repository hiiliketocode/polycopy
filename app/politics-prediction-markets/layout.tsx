...
export const metadata: Metadata = {
  ...
  description: 'Trade political prediction markets on Polymarket. Follow top politics traders, election forecasts, and copy profitable political betting strategies.',
  keywords: [
