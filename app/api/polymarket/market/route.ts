...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      minimumTickSize: typeof market?.minimum_tick_size === 'number' ? market.minimum_tick_size : null,
      minimumOrderSize: typeof market?.minimum_order_size === 'number' ? market.minimum_order_size : null,
