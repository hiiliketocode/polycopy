...
export const metadata: Metadata = {
  ...
  description: 'New to prediction markets? Learn how prediction markets work, how to get started, strategies for beginners, and common mistakes to avoid. Start trading smarter on Polymarket.',
  keywords: [
