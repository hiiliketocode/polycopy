      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 md:p-12 prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.2 Wallet Information (Premium Users Only)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.3 Blockchain and Trading Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.4 Usage Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.5 User-Generated Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.6 Payment Information</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.1 Supabase (Authentication & Database)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#FDB022] hover:text-[#E69E1A] font-medium">
                supabase.com/privacy
              </a>
              .
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.2 Turnkey (Wallet Infrastructure - Premium Only)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <a href="https://www.turnkey.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#FDB022] hover:text-[#E69E1A] font-medium">
                turnkey.com/privacy-policy
              </a>
              .
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.3 Stripe (Payment Processing)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#FDB022] hover:text-[#E69E1A] font-medium">
                stripe.com/privacy
              </a>
              .
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.4 Vercel (Hosting)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              found at{' '}
              <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#FDB022] hover:text-[#E69E1A] font-medium">
                vercel.com/legal/privacy-policy
              </a>
              .
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.5 Resend (Email Delivery)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              can be found at{' '}
              <a href="https://resend.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#FDB022] hover:text-[#E69E1A] font-medium">
                resend.com/legal/privacy-policy
              </a>
              .
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.6 Polymarket APIs & Polygon Blockchain</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.7 Google Analytics</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[#FDB022] hover:text-[#E69E1A] font-medium">
                Google Analytics Opt-out Browser Add-on
              </a>
              .
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.8 Mixpanel & Marketing Pixels (Planned)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">6.1 Account Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">6.2 Wallet Data (Premium Users)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <a href="mailto:support@turnkey.com" className="text-[#FDB022] hover:text-[#E69E1A] font-medium">
                support@turnkey.com
              </a>
              {' '}to request deletion of your private key from their systems.
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">6.3 Payment Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">6.4 Legal Retention</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">8.1 General Rights</h3>
            <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">8.2 California Privacy Rights (CCPA)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">8.3 European Privacy Rights (GDPR)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">8.4 Exercising Your Rights</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">13. Do Not Track Signals</h2>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">14. Data Breach Notification</h2>
            <p className="text-slate-700 leading-relaxed mb-4">
