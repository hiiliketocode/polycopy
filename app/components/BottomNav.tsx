    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Paper Trading - Only show for admin users */}
          {isAdmin && (
            <Link 
              href="/paper-trading" 
              className="flex-1 flex flex-col items-center justify-center gap-1"
            ...
            >
              <div style={iconContainerStyle} className="flex items-center justify-center">
                <svg 
                  className={`h-6 w-6 ${isActive('/paper-trading') ? 'text-[#0F0F0F]' : 'text-slate-400'}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
              ...
              <span className={`text-xs ${isActive('/paper-trading') ? 'text-[#0F0F0F] font-semibold' : 'text-slate-500'}`}>
                Paper
              </span>
            </Link>
          )}
