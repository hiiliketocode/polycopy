...
export const metadata: Metadata = {
  ...
  description: "Compare Polymarket to Kalshi, PredictIt, Manifold, and other prediction markets. Liquidity, fees, markets, and which platform is best for copy trading.",
  keywords: [
