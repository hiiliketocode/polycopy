...
export function StepFollowTraders({
  ...
  const minRequired = 5;
  const visibleTraders = traders.slice(0, 12);
    ...
    <div className="flex flex-col">
      ...
      <div>
        {isLoading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 pt-2">
            {visibleTraders.map((trader, index) => (
              <div key={trader.wallet} className={index >= 8 ? "hidden md:block" : ""}>
                <TraderCard
                  trader={trader}
