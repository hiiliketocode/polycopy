...
export function Navigation({ isLoggedIn = false, user }: NavigationProps) {
      ...
      <nav className="hidden md:block sticky top-0 z-50 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/pricing">
              <Button className="bg-gradient-to-r from-yellow-400 to-amber-500 hover:from-yellow-500 hover:to-amber-600 text-white font-bold shadow-lg shadow-yellow-400/30 border border-yellow-400/20 relative overflow-hidden group">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  <div className="px-2 py-2">
                    ...
                    <p className="text-xs text-slate-500">0x1234...5678</p>
                  </div>
                  <DropdownMenuSeparator />
