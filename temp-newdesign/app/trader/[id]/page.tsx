...
const mockTrader = {
  ...
  name: "Sarah Chen",
  handle: "0x742d...a3b9",
  avatar: "https://polymarket-upload.s3.us-east-2.amazonaws.com/sarah-chen-profile.png",
  isFollowing: false,
  stats: {
    roi: 47.2,
    profit: 12450,
        ...
        <Card className="bg-white border-slate-200 p-4 sm:p-8">
          <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm font-mono text-slate-500 mb-2 sm:mb-3">{mockTrader.handle}</p>
              ...
              {mockTrader.tradeHistory.map((trade) => (
                <Card key={trade.id} className="bg-white border-slate-200 p-5 hover:shadow-lg transition-all">
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      className="flex-1 min-w-0 bg-[#FDB022] hover:bg-[#FDB022]/90 text-slate-900 font-semibold shadow-sm"
                    >
                      Copy Trade
                    </Button>
                    <Button
              ...
              <Card className="bg-white border-slate-200 p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-slate-50 rounded-lg">
                    ...
                    <p className="text-lg sm:text-xl font-bold text-slate-900">{mockTrader.tradeHistory.length}</p>
                  </div>
                </div>
              </Card>
