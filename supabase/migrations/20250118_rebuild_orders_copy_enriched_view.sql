-- Rebuild the copy-trade enriched view with normalized columns and filters.
-- Keep orders as the source of truth while removing unfilled non-GTC open orders.
...
COMMENT ON VIEW public.orders_copy_enriched IS
  'Normalized copy-trade view with canonical entry/exit/invested and derived PnL fields.';
