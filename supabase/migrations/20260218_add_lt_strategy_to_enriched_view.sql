-- Add lt_strategy_id to orders_copy_enriched view so portfolio can attribute
-- trades to bots.
...
COMMENT ON VIEW public.orders_copy_enriched IS
  'Normalized copy-trade view with canonical entry/exit/invested/side, derived PnL, and lt_strategy_id for bot attribution. Uses SECURITY INVOKER to respect RLS policies.';
