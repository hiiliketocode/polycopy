            ...
            <table className="min-w-[980px] w-full text-sm">
              ...
              <tbody>
                {sortedTrades.map((trade) => (
                  <ManualCopiedTradeRow key={trade.id} trade={trade} liveMarketData={liveMarketData} />
                ))}
              </tbody>
            </table>
          </div>
  ...
  return (
    <tr className="border-b border-slate-100 bg-white">
      ...
      <td className="px-4 py-4 align-top">
        ...
        <p className="mt-1 text-sm font-semibold text-slate-900">{formatNumber(contracts)}</p>
      </td>
      <td className="px-4 py-4 align-top">
        <span className="text-[10px] uppercase tracking-wide text-slate-400 md:hidden">Entry</span>
        <p className="mt-1 text-sm font-semibold text-slate-900">{formatPrice(trade.price_when_copied)}</p>
      </td>
      <td className="px-4 py-4 align-top">
      ...
      <td className="px-4 py-4 align-top">
        ...
        <div className="text-[11px] text-slate-500 mt-1">{formatRelative(trade.copied_at)}</div>
      </td>
    </tr>
  )
}
