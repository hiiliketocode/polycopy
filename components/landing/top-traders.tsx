      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="flex items-center gap-2 lg:gap-3 mb-2 lg:mb-4">
                  ...
                  <div className="min-w-0">
                    <div className="font-bold text-foreground text-sm lg:text-base truncate">{displayName}</div>
                ...
                <div className="grid grid-cols-3 gap-2 mb-3 lg:mb-4">
                  <div className="text-center p-1.5 lg:p-2 bg-secondary/50 rounded-lg">
                  ...
                  <div className="text-center p-1.5 lg:p-2 bg-secondary/50 rounded-lg">
                    <div className="text-[10px] lg:text-xs text-muted-foreground">P&L</div>
                    <div className={`text-xs lg:text-sm font-bold ${trader.pnl >= 0 ? 'text-profit-green' : 'text-loss-red'}`}>
                      {formatLargeNumber(trader.pnl)}
                    </div>
                  </div>
                  <div className="text-center p-1.5 lg:p-2 bg-secondary/50 rounded-lg">
                    <div className="text-[10px] lg:text-xs text-muted-foreground">Vol</div>
        ...
        <div className="text-center">
          <Link href="/discover">
            <Button
              size="lg"
              className="bg-polycopy-yellow text-neutral-black hover:bg-polycopy-yellow-hover font-semibold text-sm lg:text-base px-6 lg:px-8 h-11 lg:h-12 shadow-lg shadow-polycopy-yellow/20"
            >
              Explore All Traders
              <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
